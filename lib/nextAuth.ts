...
if (isAuthProviderEnabled('azure-ad-b2c')) {
  providers.push(
    AzureADB2CProvider({
      tenantId: env.entraId.tenantName,
      clientId: env.entraId.clientId,
      clientSecret: env.entraId.clientSecret,
      primaryUserFlow: env.entraId.userFlow,
      authorization: {
        params: {
          scope: `https://${env.entraId.tenantName}.onmicrosoft.com/api/demo.read https://${env.entraId.tenantName}.onmicrosoft.com/api/demo.write offline_access openid`,
          response_type: "code", // Ensure response_type is set to 'code' for OAuth
          code_challenge_method: "S256", // Enable PKCE for secure code exchange
        },
      },
      checks: ["pkce"],
      client: {
